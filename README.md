# Step three: Force focus after clear

A basic react.js app that has an 'address finder' feature that spits out dummy data. Now when you clear the address finder using the clear button, it puts the focus back into the search input.
